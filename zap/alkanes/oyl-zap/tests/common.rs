...
pub fn setup_test_environment() -> (MockOylFactory, Vec<AlkaneId>) {
    ...
    // Adjusted WBTC/USDC reserves to create a balanced market relative to the WBTC/ETH and ETH/USDC pools.
    // Previous: 1 WBTC = 20,000 USDC. Implied (via ETH): 1 WBTC = 30,000 USDC.
